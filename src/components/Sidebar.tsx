    ...
    return (
        <Box as="aside" w="64" mr="8">
            <Stack spacing="12" align="flex-start">
                <Box>
                    <Text textAlign="center" mb="2" fontWeight="bold" color="gray.400" fontSize="small">GERAL</Text>
                ...
                <Box>
                    <Text textAlign="center" mb="2" fontWeight="bold" color="gray.400" fontSize="small">AUTOMAÇÃO</Text>
                    <Divider borderColor="blue.700" />
                    <Stack spacing="4" mt="8" align="stretch">
                        <Link display="flex" align="center">
